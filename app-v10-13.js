const VERSION = 'v10.13-mockup-home';
...
const HOME_ART = `assets/home-v10-13.png?v=${VERSION}`;
const HOME_ART_ALT = `assets/home-v10-13.png?v=${VERSION}`;
...
function scenarioArt(id){ return SCENARIO_POSTERS[id] || SCENARIO_COVER_ART; }
...
restore().then(ok=>{if(ok)renderCurrent();else renderHome();setupIntro();showIntroGate('TOUCHEZ POUR OUVRIR LA PORTE');});
